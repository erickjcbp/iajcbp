...
function _svgIcon(name) {
  const d = {
    ...
    lixeira:        'M3 6h18 M8 6V4a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v2 M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6 M10 11v6 M14 11v6',
    ...
    // ícones da tela de Tarefas em quadro (kanban): três colunas, uma lista com marcadores,
    // e as duas setas que movem o cartão entre colunas no toque (o essencial no celular).
    quadro:         'M4 4h4v16H4z M10 4h4v16h-4z M16 4h4v16h-4z',
